<%@ Page Title="Register" Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="register.aspx.cs" Inherits="CheckList.register" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        $(document).ready(function () {
            $("#txtpass").keyup(validate);
        });


        function validate() {
            var password1 = $("#txtpass").val();
            var password2 = $("#txtpass1").val();



            if (password1 == password2) {
                $("#validate-status").text("it same");
            }
            else {
                $("#validate-status").text("The password is not same please enter same as the first");
            }
